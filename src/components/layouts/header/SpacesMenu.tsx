import { EuiAvatar, EuiButton, EuiHeaderSectionItemButton, EuiPopover, EuiPopoverFooter, EuiPopoverTitle, EuiSelectable, EuiSelectableOption, EuiSelectableProps, useGeneratedHtmlId } from "@elastic/eui";
